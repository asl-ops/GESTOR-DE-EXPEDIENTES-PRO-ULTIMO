...
export const HeaderIcon = () => (
    <svg xmlns="http://www.w3.org/2000/svg" className="h-10 w-10 text-sky-600" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M19.5 14.25v-2.625a3.375 3.375 0 00-3.375-3.375h-1.5A1.125 1.125 0 0113.5 7.125v-1.5a3.375 3.375 0 00-3.375-3.375H8.25m0 12.75h7.5m-7.5 3H12M10.5 2.25H5.625c-.621 0-1.125.504-1.125 1.125v17.25c0 .621.504 1.125 1.125 1.125h12.75c.621 0 1.125-.504 1.125-1.125V11.25a9 9 0 00-9-9z" />
    </svg>
);

export const UserIcon = ({ className = "h-7 w-7 text-sky-500" }: { className?: string }) => (
...
export const CarIcon = () => (
    <svg xmlns="http://www.w3.org/2000/svg" className="h-7 w-7 text-sky-500" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M9 17a2 2 0 11-4 0 2 2 0 014 0zM19 17a2 2 0 11-4 0 2 2 0 014 0z" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M11 17H6.538C5.06 17 4.411 15.448 5.164 14.343L6.8 12.018c.24-.35.455-.72.68-1.102l.53-1.06a4.5 4.5 0 014.288-2.848H18a2 2 0 012 2v4a2 2 0 01-2 2h-1m-5-4h1m-1 4h1m-4-4h.01" />
    </svg>
);

export const EuroIcon = () => (
    <svg xmlns="http://www.w3.org/2000/svg" className="h-7 w-7 text-sky-500" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M14.121 15.536A9.004 9.004 0 0112 16c-2.672 0-5.06-1.026-6.786-2.714M15.879 12.464A9.007 9.007 0 0112 13c-2.672 0-5.06-1.026-6.786-2.714M17.636 9.393A9.008 9.008 0 0112 10c-2.672 0-5.06-1.026-6.786-2.714m0-2.572A9.005 9.005 0 0112 4c2.672 0 5.06 1.026 6.786 2.714M3 12a9 9 0 1118 0 9 9 0 01-18 0z" />
    </svg>
);
...
export const LoadingSpinner = () => (
    <div className="flex flex-col items-center justify-center h-full">
        ...
        <p className="mt-4 text-lg text-slate-600">Cargando datos...</p>
    </div>
);
...
export const FolderOpenIcon = () => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-5 h-5">
        <path strokeLinecap="round" strokeLinejoin="round" d="M19.5 14.25v-2.625a3.375 3.375 0 00-3.375-3.375h-1.5A1.125 1.125 0 0113.5 7.125v-1.5a3.375 3.375 0 00-3.375-3.375H8.25m-1.125 9h11.25m-1.125 3h11.25m-1.125 3h7.5M4.5 19.5h15a2.25 2.25 0 002.25-2.25V6.75A2.25 2.25 0 0019.5 4.5h-15a2.25 2.25 0 00-2.25 2.25v10.5A2.25 2.25 0 004.5 19.5z" />
    </svg>
);
...
export const GestoriaLogoIcon = () => (
    <div className="flex items-center space-x-2">
        <div className="flex items-center justify-center h-12 w-12 bg-slate-800 rounded-md">
            <svg width="36" height="36" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <path d="M2 7L12 12M22 7L12 12M12 22V12" stroke="white" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                <path d="M17 4.5L7 9.5" stroke="#0ea5e9" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
            </svg>
        </div>
        <div>
            <p className="font-bold text-xl text-slate-800 tracking-tight">Gestoría Arcos</p>
            <p className="text-xs text-slate-500">Soluciones Administrativas</p>
        </div>
    </div>
);
...
export const GridViewIcon = ({ className = "w-6 h-6" }: { className?: string }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
...
export const ListViewIcon = ({ className = "w-6 h-6" }: { className?: string }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
