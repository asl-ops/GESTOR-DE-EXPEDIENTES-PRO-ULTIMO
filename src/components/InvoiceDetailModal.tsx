...
import { Trash2, Send, Lock, Ban, Banknote, ShieldCheck, RefreshCcw, Calendar } from 'lucide-react';
                        ...
                        <div>
                            ...
                            {invoice.clientName ? (
                                <>
                                    ...
                                    <div className="text-xs text-slate-500 font-mono mt-1">{invoice.clientIdentity || 'Sin documento'}</div>
                                </>
                            ) : (
